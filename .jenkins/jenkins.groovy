...
def buildStrimziImages() {
    sh(script: """
        ...
        JAVA_HOME=/usr/lib/jvm/java-17-openjdk-s390x MVN_ARGS='-DskipTests -Dsurefire.rerunFailingTestsCount=5 -Dfailsafe.rerunFailingTestsCount=2' make all TESTCONTAINERS_RYUK_DISABLED=TRUE TESTCONTAINERS_CHECKS_DISABLE=TRUE
    """)
}
